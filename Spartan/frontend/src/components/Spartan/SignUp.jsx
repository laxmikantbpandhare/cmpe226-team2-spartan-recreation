                            ...
                            <form onSubmit={this.submitSignUp}>
                                ...
                                <div className="row" >
                                    ...
                                    <div className="col-sm-6 col-md-6">
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="where"><h5>First Name</h5></label>
                                            <input type="text" className="form-control" name="firstname" id="firstname" placeholder="Your First Name" value={this.state.firstname} onChange={this.handleChange} required />
                                    ...
                                    <div className="col-sm-6 col-md-6">
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="where"><h5>Last Name</h5></label>
                                            <input type="lastname" className="form-control" name="lastname" id="lastname" placeholder="lastname" value={this.state.lastname} onChange={this.handleChange} required />
                                        </div>
                                ...
                                <div className="row" >
                                    ...
                                    <div className="col-sm-6 col-md-6">
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="where"><h5>City</h5></label>
                                            <input type="text" className="form-control" name="city" id="city" placeholder="city" value={this.state.city} onChange={this.handleChange} required />
                                        </div>
                                    ...
                                    <div className="col-sm-6 col-md-6">
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="where"><h5>Phone Number</h5></label>
                                            <input type="text" className="form-control" name="phoneno" id="phoneno" placeholder="phoneno" value={this.state.phoneno} onChange={this.handleChange} pattern="[0-9]{10}" required />
                                        </div>
                                    ...
                                    <div className="col-sm-6 col-md-6">
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="where"><h5>Country</h5></label>
                                            <input type="text" className="form-control" name="country" id="country" placeholder="country" value={this.state.country} onChange={this.handleChange} required />
                                        </div>
